...
void x86_pclmullqlqdq(SecBuf *s, X86XmmReg d, X86XmmReg sr);
void x86_pclmullqhqdq(SecBuf *s, X86XmmReg d, X86XmmReg sr);
void x86_pclmulhqlqdq(SecBuf *s, X86XmmReg d, X86XmmReg sr);
void x86_pclmulhqhqdq(SecBuf *s, X86XmmReg d, X86XmmReg sr);
...
void x86_vpsllq_128_i(SecBuf *s, X86XmmReg d, uint8_t imm);
void x86_vpsrlq_128_i(SecBuf *s, X86XmmReg d, uint8_t imm);
