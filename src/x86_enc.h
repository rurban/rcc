...
void x86_add_mr(SecBuf *s, int size, X86Mem dst, X86Reg src);
...
void x86_sub_mr(SecBuf *s, int size, X86Mem dst, X86Reg src);
...
void x86_and_mr(SecBuf *s, int size, X86Mem dst, X86Reg src);
...
void x86_or_mr(SecBuf *s, int size, X86Mem dst, X86Reg src);
...
void x86_xor_mr(SecBuf *s, int size, X86Mem dst, X86Reg src);
