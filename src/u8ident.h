...
enum u8id_profile {
    ...
    // PROFILE_4 + Greek with only Allowed ID's ("TR39")
...
enum u8id_options {
  ...
  U8ID_TR31_TR39 = 67, // practical XID with TR39 security measures. see doc/D2528R1.md
  U8ID_TR31_C23 = 68, // XID with NFC from the C23 standard (P1949, N2828).
