...
c: UX improvements to 'too {few,many} arguments' errors (v5) [<a class="bz_bug_link 
    struct p {
            int (*bar)();
    };
...
//             <a class="bz_bug_link 
//           bz_status_NEW "
//    title="NEW - Unhelpful "too many arguments to function" error message (especially w/ C23)"
//    href="show_bug.cgi?id=118112">PR c/118112</a>
