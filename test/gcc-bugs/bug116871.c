...
typedef void (*__sighandler_t) (int);
    ...
    void new_process(void)
    {
      ...
      int_stat = signal(2,  ((__sighandler_t) 1)); /* { dg-error "assignment to .void .*..void... from incompatible pointer type" } */
...
//     /* Mismatching return type (RETSIGTYPE was int in the original).  */
