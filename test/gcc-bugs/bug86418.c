...
// For call to a function without a function prototype in scope where the
// function is defined with a function prototype, either the prototype ends with
// an ellipsis or the types of the arguments after promotion are not compatible
// with the types of the parameters (6.5.2.2).
// ...
// Atm, the only warning we get is when cloning:
// ...
// $ gcc -O2 pr48063.c -Wall
// pr48063.c: In function 'bar.constprop':
// pr48063.c:18:6: warning: 'i' is used uninitialized in this function [-Wuninitialized]
//   if (i)
//       ^
// ...
