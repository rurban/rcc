...
A (sizeof (S0) == 1); /* { dg-error "static assertion failed" } */
A (sizeof (S1) == 1); /* { dg-error "static assertion failed" } */
A (sizeof (S2) == 1); /* { dg-error "static assertion failed" } */
A (sizeof (S3) == 1); /* { dg-error "static assertion failed" } */
// + for lang in c c++
