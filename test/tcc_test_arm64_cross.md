...
| test_include                | EXEC_FAIL | exit=42                   |
| test_include2               | EXEC_FAIL | exit=10                   |
...
| test_self_include2          | EXEC_FAIL | exit=1                    |
| test_signextend             | PASS      | exit=0                    |
| test_simple                 | EXEC_FAIL | exit=1                    |
| test_simple2                | EXEC_FAIL | exit=1                    |
