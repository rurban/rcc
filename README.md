...
TODO: trampolines, fmv (we do have asm .altinstr_replacement support already),
full \_Decimal/Float/Binary support (still aliased to float), C23
`_BitInt`, `#embed`, `<stdbit.h>`, decimal float types.
