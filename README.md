...
darwin-cross. On Linux we achieved a 100% pass rate (1809/1809) on the GCC torture suite.
...
aarch64 on macos) on all our testsuites. 1809/1809 GCC torture tests passed on Linux (100%).
...
| rcc      | macOS    | 1801   | 5      | 259     | 5 float/complex fails  |
| rcc      | Windows  | 1801   | 3      | 261     | 3 runtime fails        |
